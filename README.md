...
**The wipe.** Switching nooks floods the screen with the new club's colour from the disc you pressed, like a story advancing, and lifts away over a room that has already changed colours. It is the one piece of motion in the app that is there for show, and it is a cut under reduced motion.
